...
class TransactionExtractor:
    ...
    async def process_invoice(self, pdf_bytes: bytes, filename: str = "document") -> InvoiceResponse:
        """
        ...
        try:
            ...
            transactions, invoice_total, due_date = await self.ai_provider.extract_transactions(
                text, institution
            )
            ...
            metadata = ProcessingMetadata(
                ...
                provider=self.ai_provider.name if hasattr(self, 'ai_provider') else "error",
                institution="unknown",
            )
